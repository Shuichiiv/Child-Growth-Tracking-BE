    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                (NEWID(), 'Alice', 'Johnson', 'parent1', HASHBYTES('SHA2_256', 'abcABC123'), 'parent1@example.com', '1234567890', '123 Main St', 1, GETUTCDATE(), 'image1.jpg', 1), 
                (NEWID(), 'Bob', 'Williams', 'parent2', HASHBYTES('SHA2_256', 'abcABC123'), 'parent2@example.com', '0987654321', '456 Oak St', 1, GETUTCDATE(), 'image2.jpg', 1),
                (NEWID(), 'John', 'Doe', 'doctor1', HASHBYTES('SHA2_256', 'abcABC123'), 'doctor1@example.com', '1112223333', '789 Pine St', 2, GETUTCDATE(), 'image3.jpg', 1),
                (NEWID(), 'Jane', 'Smith', 'doctor2', HASHBYTES('SHA2_256', 'abcABC123'), 'doctor2@example.com', '4445556666', '321 Birch St', 2, GETUTCDATE(), 'image4.jpg', 1),
                (NEWID(), 'Admin', 'Manager', 'manager', HASHBYTES('SHA2_256', 'abcABC123'), 'manager@example.com', '7778889999', '654 Cedar St', 0, GETUTCDATE(), 'image5.jpg', 1);
